...
(function(){
  languageSwitcher();
  $("[data-translate]").jqTranslate('/assets/json/data',{defaultLang: 'en'});
})();
function language(language) {
  $("[data-translate]").jqTranslate('/assets/json/data',{forceLang: language});
}
...
$(function() {
  ...
  var subscribe = $(parent).children('#about');
  ...
  $(parent).on('click', function(event) {
    ...
    } else if (event.target.hash === '#about' || event.target.classList.contains('subs')) {
...
$(function() {
  ajaxMailChimpForm($("#about-form"), $("#about-result"));
  ...
  function ajaxMailChimpForm($form, $resultElement){
      ...
      $form.submit(function(e) {
          ...
          if (!isValidEmail($form)) {
            ...
            setTimeout(function() {
              if ( $('#about').hasClass('vertical') ) {
                $('body').prepend('<div class="loading"></div>');
              } else {
                $('#about').append('<div class="loading"></div>');
              }
